      ...
      <article>
        ...
        <div class="post col-12 col-md-10 col-lg-8">
          <ul class="meta">
            ...
            <li class="category">{{data.type}}</li>
          </ul>
          <h1>{{data.title.rendered}}</h1>
          <img v-bind:src="data.featuredimage.src" v-bind:srcset="data.featuredimage.srcset" class="page" />
          <div class="content" v-html="data.content.rendered"></div>
          <ul class="footer">
            <li class="attachment" v-if="data.file_attachment.url">
              <a v-bind:href="data.file_attachment.url" v-bind:title="'Download story attachment ' + data.file_attachment.name">Download ({{data.file_attachment.extension}})</a></li>
